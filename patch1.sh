...
# rm -rf /var/cache/dnf && dnf clean all && dnf update -y && dnf upgrade -y && dnf install -y php-pear php-devel php-zip

# curl --silent --location https://dl.yarnpkg.com/rpm/yarn.repo | tee /etc/yum.repos.d/yarn.repo
# rpm --import https://dl.yarnpkg.com/rpm/pubkey.gpg

# rm -rf /var/cache/dnf && dnf clean all && dnf upgrade -y && dnf install -y php-pear php-devel php-zip @nodejs yarn
rm -rf /var/cache/dnf && dnf clean all && dnf update -y && dnf upgrade -y && dnf install -y sudo php-pear php-devel php-zip memcached
