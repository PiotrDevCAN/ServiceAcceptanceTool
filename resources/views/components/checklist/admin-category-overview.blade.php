                    ...
                    <div class="ibm-fluid">
                        ...
                        <div class="ibm-col-12-6">
                            <p class="ibm-btn-row ibm-ind-link ibm-center">
                                <a id="services_overview" class="ibm-btn-pri ibm-edit-link ibm-btn-red-50" href="{{ route('admin.checklist.edit', ['checklist' => $record->id]) }}#services-overview">Manage Check List Services</a>
                            </p>
                        </div>
                    </div>
